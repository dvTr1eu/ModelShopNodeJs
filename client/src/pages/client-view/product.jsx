import ProductFilter from "@/components/client-view/filter";
...
import { ArrowUpDownIcon, LoaderPinwheel } from "lucide-react";
...
function ClientProduct() {
  ...
  const sizeSearchParam = searchParams.get("size");
